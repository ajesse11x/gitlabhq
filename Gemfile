...
gem 'rails', '>= 4.2.10', gem_versions['rails']
...
gem 'rails-i18n', '>= 4.0.9', gem_versions['rails-i18n']
...
group :development, :test do
  ...
  gem 'activerecord_sane_schema_dumper', '>= 0.2', gem_versions['activerecord_sane_schema_dumper']
