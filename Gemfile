...
gem 'rails', '>= 6.1.7.3', gem_versions['rails']
...
gem 'recaptcha', '~> 3.0', '>= 3.0.0', require: 'recaptcha/rails'
gem 'akismet', '~> 2.0'
...
gem 'rails-i18n', '>= 6.0.0', gem_versions['rails-i18n']
...
gem 'rbtrace', '~> 0.4', '>= 0.4.10', require: false
